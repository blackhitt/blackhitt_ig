#!/usr/bin/env python
# -*- coding: utf-8 -*-
#by ucup hacking jan rename seenaknya gk bisa run salah lu sendiri kntl
Los, xx, un = 0, 0, []
   ...
   def milju(self):
       def uwu(s):
          for c in s + '\n':
           ...
           sys.stdout.flush()
           time.sleep(1./500)
       RSAPubKey = "<RSAKeyValue><Modulus></Modulus><Exponent>AQAB</Exponent></RSAKeyValue>"
       auth = "WyIxMDI2MzI3OTkiLCJxZGN2TnF5U0ZvRHErSmhnZ0kvblRIbmR2R3pKcTRJVHpiODlqek95Il0="
       print("Sekarang Tanggal: ", datetime.datetime.now())
       print("""
╭╮╭┳━┳╮╭┳━╮
┃┃┃┃╭┫┃┃┃╋┃
┃╰╯┃╰┫╰╯┃╭╯
...
''')
   ...
   def aset_ig(self):
       ...
       if os.path.isfile('IG-login.txt') is True:
           ...
           os.system('clear' if sys.platform.lower() == 'linux' else 'cls')
           #self.milju() # Jangan di ubah ubah memeq ntar eror asu o jancok 
           os.system('clear' if sys.platform.lower() == 'linux' else 'cls')
           self.Me()
 ...
 05. SIMPAN HASIL CRACK''',True)
   ...
   def chs(self, assets):
       while True:
         ...
         elif x in ['09','9']:exit(os.system('xdg-open https://wa.me/+6282245365418?text='))
...
[white] 01. Set Tema Hijau          04. Set Tema Putih\n\
 ...
 07. Set Tema Default',True)
   ...
   def Unli(self, cokie):
       ...
       self.user = Console(style=Tema[0]).input(f'   └──> ucup')
       try:
       ...
       try:
          ...
          for asu in dirs:
              if 'CP' not in str(asu):pass
                  ...
                  print(f' {asuu}. {asu}')
          print('')
          self.MyRich('[white]Masukan Nama file. Jangan Angkanya kontol dah gua ulang vdio di group aja cok ni contoh: CP/Example.txt',True)
